...
page = st.sidebar.radio("Choose a page", ["Risk Projection", "Page 2", "Page 3"])

if page == "Risk Projection":
    # Judul Aplikasi
    ...
    st.title("Page 3")
    st.write("This is Page 3. You can add your content here.")
