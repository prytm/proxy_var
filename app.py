...
if min_stocks_without_subsektor:
    ...
    with col_plot:
        ...
        try:
            ...
            rolling_std_n = daily_returns_2[not_subsektor_stock].rolling(window=10, min_periods=1).std() * 2
            rolling_mean_n = daily_returns_2[not_subsektor_stock].rolling(window=10, min_periods=1).mean()
